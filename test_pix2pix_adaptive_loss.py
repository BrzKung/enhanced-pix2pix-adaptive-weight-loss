...
# Import from modules
from test_config import DEVICE, LEARNING_RATE, transform_resize
...
checkpoint = 2271
file_path = f"./result/pix2pix_adaptive_loss/recent/{checkpoint}_epochs"
checkpoint_path = f"./checkpoints/pix2pix_adaptive_loss/recent/gen_{checkpoint}.pth.tar"
