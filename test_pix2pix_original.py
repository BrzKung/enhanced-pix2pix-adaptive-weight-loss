...
# plt.plot(history_df["epoch"], history_df["validation_loss"], label="Validation Loss", color="blue", linestyle='-')
# plt.plot(history_df["epoch"], history_df["generator_loss"], label="Generator Loss", color="green", linestyle='-')
plt.plot(
    history_df["epoch"],
...
# history_df = pd.read_csv(f'{file_path}/history_300.csv')
"""
plt.figure(figsize=(8, 5))
plt.plot(
    history_df["epoch"],
    history_df["l1_lambda"],
    label="L1 Lambda",
    color="red",
    linestyle="-",
)
plt.plot(
    history_df["epoch"],
    history_df["perc_lambda"],
    label="Percebtual Lambda",
    color="blue",
    linestyle="-",
)
plt.plot(
    history_df["epoch"],
    history_df["style_lambda"],
    label="Style Lambda",
    color="green",
    linestyle="-",
)
...
plt.title("Loss Lambda")
plt.legend()
plt.grid(True)
plt.savefig(f"{file_path}/graph_2.jpg", format="jpg", dpi=300)
plt.show()
"""
import matplotlib.pyplot as plt
import pandas as pd
...
plt.plot(
    history_df["epoch"],
    history_df["perc_loss"],
    label="Percebtual Loss",
    color="blue",
    linestyle="-",
)
plt.plot(
    history_df["epoch"],
    history_df["style_loss"],
    label="Style Loss",
    color="green",
    linestyle="-",
)
